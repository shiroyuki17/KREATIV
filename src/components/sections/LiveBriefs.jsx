        ...
        <div className="mt-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {PICKED.map((job) => (
            <button
              ...
              className={`group relative flex aspect-[4/3] flex-col justify-between overflow-hidden rounded-2xl bg-gradient-to-br p-4 text-left transition-transform duration-300 hover:-translate-y-1 ${CAT_GRAD[job.cat]}`}
            >
