          ...
          {TILES.map((t, i) => {
            if (t.kind === "talent") {
              ...
              return (
                <button
                  ...
                  className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br text-left ${tile.grad} ${t.tall ? "row-span-2" : ""}`}
                >
            ...
            return (
              <button
                ...
                className={`group relative flex flex-col justify-end overflow-hidden rounded-2xl border border-white/8 bg-white/[0.03] p-3.5 text-left transition-colors hover:border-brand/40 ${t.tall ? "row-span-2" : ""}`}
              >
